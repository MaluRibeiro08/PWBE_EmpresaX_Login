...
session_start();
require_once("./funcoes.php"); //verifica se já foi chamado, porque se já foi, ele não chama de novo, usa o que já tem
verificarLogin();

$funcionarios = lerAquivo("./dados/empresaX.json");
...
if(isset($_GET["idFuncionarioApagar"])) 
{
    ...
    apagarFuncionario("./dados/empresaX.json", $funcionarios, $idFuncionarioApagar );
